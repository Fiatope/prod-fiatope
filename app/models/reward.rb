...
class Reward < ActiveRecord::Base
  ...
  mount_uploader :uploaded_image, RewardUploader, mount_on: :uploaded_image
  ...
  validates_numericality_of :maximum_articles, only_integer: true, greater_than: 0, allow_nil: true
