...
describe Neighborly::Mangopay::Creditcard::TransactionAdditionalFeeCalculator do
  ...
  context "when gross amount doesn't need more then 2 decimal places of precision" do
    ...
    it "has gross amount equal following Mangopay's formula" do
      expect(subject.gross_amount).to eql(1018)
    end
