...
desc 'This tasks should be executed 1x per hour'
task notify_project_owner_about_new_confirmed_contributions: :environment do
  Project.with_contributions_confirmed_this_hour.each do |project|
  ...
  Project.with_contributions_canceled_this_hour.each do |project|
    Notification.notify_once(
